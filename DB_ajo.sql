...
INSERT INTO EHDOKKAAT VALUES (9, 'Alasalmi', 'Otto', 'Suomen Sosialidemokraattinen Puolue', 'Varkaus', 30, 'Suomi kaipaa uusia ideoita ja niitä minulta löytyy.  Tämä maa kaipaa yhteistyötä.  Katson eteenpäin, uskon parempaan ja puolustan heikoimpia.', 'EU:sta eroaminen on tärkeintä! En ole tehnyt koskaan palkkatyötä, joten yrittäjyys on myös sydämmen asia! Ei NATO, ei EU, ei TTIP, ei GMO ei €uro! KYLLÄ ITSENÄISYYS JA KANSANVALTA! Suomeen tulee saada myös perustuslakituomioistuin joka valvoo hallituksen tekemisiä ja päätöksien laillisuutta! ETA-sopimus riittää meille! Se takaa koulutuksen, liikkumisen ja kaupankäynnin EU:n alueella!', 'Freelancer-kirjoittaja');
INSERT INTO EHDOKKAAT VALUES (10, 'Alatalo', 'Cosmo', 'Suomen Keskusta', 'Tampere', 68, 'Olen tarmokas yhteisten asioiden hoitaja ja minulla on 20 vuoden kokemus ihmisten asioiden hoitamisesta. Viime kunnallisvaaleissa sain luottamuksen osoituksena ääniharavan aseman kaupungissani.', 'Poliitikot eivät luo työpaikkoja, vaan rakentavat raamit. Työllisyysaste on saatava nostettua Ruotsin tasolle, ja rakenteellisia uudistuksia julkisella sektorilla sekä myös työmarkkinoilla on tehtävä, jotta työn verotusta ja työllistymisen esteitä voidaan olennaisesti pienentää.     Turhaa yrittäjyyttä ja talouselämää kuristavaa sääntöjen ja kieltojen viidakkoa pitää vähentää.     Tulen paneutumaan työttömyyden ja syrjäytymisen ehkäisemiseen.', 'Opiskelija / Työntekijä');
INSERT INTO EHDOKKAAT VALUES (11, 'Albert', 'Essi', 'Suomen Keskusta', 'Turku', 47, 'Vaikka se kliseiseltä kuulostaakin, ajaisin kaikkien asiota eduskunnassa, eikä minulla ole hämäriä motiiveja. Eduskunnassa haluan luoda yhteiskuntaa, jossa kaikille riittää rakkautta.', 'Tasapainoista valtiontaloutta, uskottavaa puolustuskykyä, turvallista arkea, koulutuksen monipuolisuutta ja suurempaa yksilönvapautta.', 'Nörtti');
INSERT INTO EHDOKKAAT VALUES (12, 'Alén', 'Mikko', 'Itsenäisyyspuolue', 'Kuopio', 82, 'Tavoitteenani on tuode tuoreita ja moderneja ajatuksia valtaapitävien puolueiden kurjistamalle poliittiselle kentälle.  Pienen puoleen ehdokkaana vanhuksien määrittämä puoluekuri ei rajoita minua.', 'JÄRKEÄ SÄÄNTELYYN, TILAA TYÖLLE JA VALINNOILLE.  Suomi tarvitsee työtä ja liikettä. Turhaa byrokratiaa ja ylisääntelyä pitää purkaa, jotta yrittäjyydelle, toimeliaisuudelle ja arjen valinnoille syntyy tilaa. Esimerkiksi kaupan aukioloaikojen ja sijainnin sääntelyä tulee vapauttaa. Erityisesti pk-yritysten velvoitteita pitää keventää. Lakien vaikutukset on arvioitava paremmin.    LAPSILLE, NUORILLE JA PERHEILLE ASIAN AJAJA  Perheet tarvitsevat tukea ja joustoja työn ja perheen yhteensovittamiseksi. Kotihoidontuen jakaminen on perheen oma asia. Suomalaisesta laadukkaasta varhaiskasvatuksesta ja koulutuksesta on pidettävä kiinni, eikä koulutuksesta ole enää varaa leikata.    ARJEN TURVALLISUUTTA JA VAHVEMPAA OIKEUSTURVAA  Arjen turvallisuutta ja oikeusturvaa tulee vahvistaa. Poliisin, oikeuslaitoksen ja puolustusvoimien toimintakyky on turvattava. Tämä edellyttää riittäviä voimavaroja ja uudistuksia. Vakavien henkeen ja terveyteen, erityisesti lapsiin kohdistuvien rikosten rangaistuksia tulee koventaa.', 'Esiintyvä taiteilija, showmies, itsensänolaaja');
INSERT INTO EHDOKKAAT VALUES (13, 'Alho', 'Inna ', 'Kansallinen Kokoomus', 'Kouvola', 62, 'Haluan edistää kokonaisvaltaisen hyvinvoinnin kasvua ilman eturyhmäpolittista suuntautumista.', 'Tahdon olla mukana rakentamassa vastuullista ja kannustavaa yhteiskuntaa, jossa sivistykseen panostetaan. Työllisyyden edistäminen ja koulutukseen panostaminen ovat tulevaisuuden hyvinvoinnin kannalta keskeisiä asioita. Työ on hyvinvoinnin tae niin yksilön kuin yhteisön tasolla. Siksi työllistämisen esteitä pitää purkaa. Koulutus on avain tulevaisuuteen - nyt on aika alkaa kehittää suomalaista koulua ja oppimista!', '"Uuden ajan sekatyömies"');
INSERT INTO EHDOKKAAT VALUES (14, 'Alhojärvi', 'Mikael ', 'Suomen Kommunistinen Puolue', 'Lappeenranta', 19, 'Toisin eduskuntaan en vain yhtä, vaan useita uusia näkökulmia.', 'Perusoikeuksien puolesta taistelija. Läpinäkyvyyttä, luotettavuutta ja oikeudenmukaisuutta päätöksentekoon. Lupauksistaan kiinni pitävä, takki ei käänny vaalien jälkeenkään.', 'Everstiluutnantti evp, taksin kuljettaja');
INSERT INTO EHDOKKAAT VALUES (15, 'Alhonnoro', 'Jasmine ', 'Vihreä liitto', 'Tampere', 53, 'Olen valmis ajamaan suurempiakin rakenne uudistuksia suomen kilpailukyvyn parantamiseksi. Luotan suomalaisiin, että he itse tietävät mikä on parasta heille itselleen eikä niinkään valtiovalta.', 'Pitkäaikainen kokemus ihmisten parissa tomimisessa - työ, yritys, urheilu sekä järjestöjen parissa. Kunnallispolitiikassa toimiminen jo 80 - 90 luvuilla...', 'Valokuvaaja, ark.yo');
INSERT INTO EHDOKKAAT VALUES (16, 'Alijärvi', 'Daniel', 'Suomen Sosialidemokraattinen Puolue', 'Helsinki', 20, 'Pidän sanani', 'Päätöksenteko kaipaa osaavia, yhteistyökykyisiä, kokeneita ja hyvät johtamistaidot omaavia tulevia kansanedustajia.', 'erityisasiantuntija');
INSERT INTO EHDOKKAAT VALUES (17, 'Allahmoradi', 'Tuomas', 'Vasemmistoliitto', 'Inkoo', 73, 'För att det behöv någon som för fram de liberala borgerliga värderingarna och någon som inte är rädd att fatta också svåra beslut.', 'Oma maa mansikka, muu maa mustikka', 'Mediapastori');
INSERT INTO EHDOKKAAT VALUES (18, 'Anderson', 'Otto', 'Suomen ruotsalainen kansanpuolue', 'Vantaa', 45, 'Minulla on erityisavustajatyöni kautta vankka kokemus valtakunnan poliitikasta. Hallitsen eri kiemurat ja tiedän miten asiat saadaan maaliin.', 'Eduskuntaan tarvitaan piraatti. Teknologinen kehitys on yhteiskunnan suurin muutosvoima ja se pitää huomioida päätöksentekoprosessissa. Olen DI/fyysikko sekä opettaja ja osaava vaikuttaja.', 'maa- ja metsätalouden harjoittaja, sijaispappi');
INSERT INTO EHDOKKAAT VALUES (19, 'Andersson ', 'Cosmo', 'Vasemmistoliitto', 'Joensuu', 41, 'Minusta saisi omistautuneet kansanedustajan jolla on vapauteen ja sosiaaliseen oikeudenmukaisuuteen pohjautuvat arvot, vahvat mielipiteet ja kykyä yhteistyöhön.', 'Olen uskonnoton yksilönvapauden kannattaja.  NATO myönteinen, ydinvoiman kannattaja.', 'Kansanedustaja');
INSERT INTO EHDOKKAAT VALUES (20, 'Andersson', 'Essi', 'Suomen ruotsalainen kansanpuolue', 'Kouvola', 63, 'SUOMEN TALOUSNÄKYMÄT OVAT KATASTROFAALISIA  On tärkeä alkaa kohottamaan Suomen taloutta.   Sitä varten pitää saada päätösvallan Suomeen  eroamalla EU:sta ja jostakin muista liitoista.', 'Mnulla on fysiikan tohtorina vahva tieteellinen koulutus ja ohjelmistoyrittäjänä paljon kokemusta yhteiskunnasta, ml. julkishallinnosta. Näkemys ja kyky uudistuksiin on vahvuuteni.', 'rakennusmestari');
...
INSERT INTO KYSYMYKSET VALUES (4, 'Työntekijälle on turvattava lailla minimityöaika.');
INSERT INTO KYSYMYKSET VALUES (5, 'Ansiosidonnaisen työttömyysturvan kestoa pitää lyhentää.');
